 ...
 * @author Christopher
 */
public class urbano_M extends javax.swing.JFrame {

    /**
     * Creates new form urbano_M
     */
    public urbano_M() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(430, 10, 210, 160));

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/comprasM.PNG"))); // NOI18N
        ...
        getContentPane().add(añadir1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 510, -1, -1));
        ...
        getContentPane().add(añadir2, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 510, -1, -1));
        ...
        getContentPane().add(añadir3, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 510, -1, -1));

        talla1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "talla", "39", "40", "41", "42", "43" }));
        getContentPane().add(talla1, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 510, 90, 30));

        talla2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "talla", "39", "40", "41", "42", "43" }));
        getContentPane().add(talla2, new org.netbeans.lib.awtextra.AbsoluteConstraints(440, 510, 90, 30));

        talla3.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "talla", "39", "40", "41", "42", "43" }));
        getContentPane().add(talla3, new org.netbeans.lib.awtextra.AbsoluteConstraints(690, 510, 90, 30));
        ...
        jLabel4.setText("Bienvenido a Urbano");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(urbano_M.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
