...
public class infoEmpresa extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("La tienda King Monkey se encarga de la venta de zapatillas a todo el Perú");
        getContentPane().add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 150, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 255, 255));
        jLabel4.setText("gracias a nuestros colaboradores como Nike y aparte de grupos de futbolistas que promocionen sus zapatillas");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 190, -1, -1));

        jLabel5.setFont(new java.awt.Font("Dialog", 1, 16)); // NOI18N
        jLabel5.setForeground(new java.awt.Color(0, 255, 255));
        jLabel5.setText("Cuando desea realizar una compra van a ver diferentes apartados de diferentes variedades como los siguientes: ");
        getContentPane().add(jLabel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(8, 230, 870, -1));
        ...
        jButton3.setText("NOVEDADES");
        jButton3.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jButton3ActionPerformed(evt);
            }
        });
        getContentPane().add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 300, 210, 50));
        ...
        getContentPane().add(jButton5, new org.netbeans.lib.awtextra.AbsoluteConstraints(730, 490, 140, 40));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagenes/variedad.PNG"))); // NOI18N
        jLabel1.setMaximumSize(new java.awt.Dimension(1984, 2232));
        jLabel1.setMinimumSize(new java.awt.Dimension(1984, 2232));
        jLabel1.setPreferredSize(new java.awt.Dimension(1984, 2232));
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        variedad reg =new variedad();
        this.dispose();
        reg.setVisible(true);
    }//GEN-LAST:event_jButton5ActionPerformed

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        novedades_info og =new novedades_info();
        this.dispose();
        og.setVisible(true);
